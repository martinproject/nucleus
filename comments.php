...
/*-----------------------------------------------------------------------------------*/
		...
		<div class="comment-title-wrap clearfix">
			...
			<h3 id="comments"><?php comments_number(__('No Comments', 'framework'), __('One Comments', 'framework'), __('% Comments', 'framework')); ?></h3>
			
			<p><a href="#respond"><?php _e('Leave a Comment', 'framework'); ?> &rarr;</a></p>
...
/*-----------------------------------------------------------------------------------*/
	...
	<div id="respond" class="clearfix">
		...
		<?php 
		$desc = get_option('tz_respond_caption'); 
		if($desc != '') :
		?>
		<p id="respond-caption"><?php echo stripslashes(htmlspecialchars_decode(nl2br($desc))); ?></p>
		<?php endif; ?>
